    <header class="bg-black p-2">
        <div class="container flex items-center flex-col sm:flex-row justify-between mx-auto text-white">
            <a href="../BayasCrud/presentar.php" class="flex items-center">
            ...
            <nav id="nav"
                class="opacity-0 h-0 invisible sm:visible sm:h-auto sm:opacity-100 sm:flex gap-2 flex-col text-center sm:flex-row sm:justify-between sm:gap-4 sm:text-2sm transition-all duration-300 ease-in-out">
                ...
                <a class="hover:text-orange-500 text-lg sm:text-base" href="../renta_autos/presentar.php">Reserva de Autos</a>
